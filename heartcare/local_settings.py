"""
Local settings for BKSP project.
...
SECRET_KEY = '$utshee^ekc1yeee49ajl^-%1_wd)p@-e$ijoy71bqfm_iq=d4'
...
DB_CONFIG = {
    ...
    'NAME': os.getenv('DB_NAME', 'bksp_db'),
    'USER': os.getenv('DB_USER', 'bksp_user'),
    'PASSWORD': os.getenv('DB_PASS', 'bksp_pass')
}
